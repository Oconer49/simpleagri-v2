...
class ControladorTerrenos {
  ...
  Future listadoTabla({
    ...
    var dd = await controlador.callMethod(
        "PruebaTecnica", "obtener_terrenos", Map());
  ...
  Future consultar(
    ...
    Map parametros = {"nombre": nombre, "codigo": codigo};

    //aqui devuelve una lista con los datos buscados
    var ee = await controlador.callMethod(
        "PruebaTecnica", "cultar_terrenos", parametros);
